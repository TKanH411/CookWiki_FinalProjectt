...
function ImageUpload(
    ...
    const [fileUploaded, setFileUploaded] = useState(value || []);
    const handleFileControlRef = useRef(false);

    useEffect(() => {
        if (value && JSON.stringify(value) !== JSON.stringify(fileUploaded) && !handleFileControlRef.current) {
    ...
    const handleFileChange = (event) => {
        handleFileControlRef.current = true;
